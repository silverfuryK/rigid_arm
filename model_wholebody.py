...
class CassieArmEnv(Env):
	...
	def calculate_foot_reward(self, weight_in_polygon = 2, weight_foot_ori = 0.8, weight_heel_toe_z = 1.5, weight_foot_y = 0.1):
	...
	def reset_model(self, target_pose = None, seed = None, random = False):
		...
		if not random:
			...
			r_var = np.random.choice([True, False])
			if r_var:
				self._update_init_qpos()
